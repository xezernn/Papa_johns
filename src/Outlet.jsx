...
function Outlet({ sebet, setSebet }) {
    ...
    return (
        <>
            <Routes>
                ...
                <Route path='/' element={<Main sebet={sebet} setSebet={setSebet} data={data} setData={setData} />} />
                <Route path='/product/:id' element={<Product data={data} setData={setData}/> } />
            </Routes>

            {/* <Main sebet={sebet} setSebet={setSebet} data={data} setData={setData} />
